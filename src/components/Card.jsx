...
export default function Card({data, remove}) {
    ...
    return (
    <div className='relative flex p-3 transition-shadow border rounded-md shadow-lg hover:shadow-2xl max-sm:items-center max-sm:flex-col border-black/5 group'>
        <button 
        onClick={() => remove(data.id)}
        className='absolute items-center justify-center hidden w-8 h-8 text-xl text-white bg-red-600 rounded-full group-hover:flex -right-3 -top-3'>
